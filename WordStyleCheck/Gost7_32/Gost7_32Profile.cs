...
namespace WordStyleCheck.Gost7_32;
...
public class Gost7_32Profile : IProfile
{
    ...
    [
        ...
        new IncorrectCaptionedNumberingLint(CaptionType.Figure, "IncorrectFigureNumbering", "FigureNumberingMix"),
        new IncorrectCaptionedNumberingLint(CaptionType.Listing, "IncorrectListingNumbering", "ListingNumberingMix"),
        new IncorrectCaptionedNumberingLint(CaptionType.Table, "IncorrectTableNumbering", "TableNumberingMix"),
